        ...
        <div className={style.card}>
            <div className={style.card__description}>
                <div className={style.card__description_mobile}>
                    ...
                    <h2 className={style.price}>{ticket["price"]} &#8381;</h2>
                </div>

                <button className={style.description__button} onClick={openModal}>
                    Выбрать
                </button>
            </div>
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} ticketFlightNumber={ticket["flight_number"]}
